...
#nullable enable
        public async Task<IResult?> PostAsync(SendMessageCommand body, Action<ChatRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<IResult> PostAsync(SendMessageCommand body, Action<ChatRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
