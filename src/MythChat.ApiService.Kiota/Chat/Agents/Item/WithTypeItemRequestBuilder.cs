...
using MythChat.ApiService.Kiota.Chat.Agents.Item.Item;
...
using System;
namespace MythChat.ApiService.Kiota.Chat.Agents.Item {
    /// <summary>
    ...
    public class WithTypeItemRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the MythChat.ApiService.Kiota.chat.agents.item.item collection</summary>
