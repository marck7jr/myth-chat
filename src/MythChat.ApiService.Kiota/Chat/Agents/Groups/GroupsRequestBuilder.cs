...
using MythChat.ApiService.Kiota.Chat.Agents.Groups.Item;
...
using System;
namespace MythChat.ApiService.Kiota.Chat.Agents.Groups {
    /// <summary>
    /// Builds and executes requests for operations under \chat\agents\groups
    /// </summary>
    public class GroupsRequestBuilder : BaseRequestBuilder {
        /// <summary>Gets an item from the MythChat.ApiService.Kiota.chat.agents.groups.item collection</summary>
