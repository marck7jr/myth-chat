...
using MythChat.ApiService.Kiota.Client.Chat.Agents.Groups;
using MythChat.ApiService.Kiota.Client.Chat.Agents.Item;
...
using System;
namespace MythChat.ApiService.Kiota.Client.Chat.Agents {
    /// <summary>
    ...
    public class AgentsRequestBuilder : BaseRequestBuilder {
        ...
        /// <summary>Gets an item from the MythChat.ApiService.Kiota.Client.chat.agents.item collection</summary>
...
#nullable enable
        public async Task<GetAgentsResponse?> GetAsync(Action<AgentsRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<GetAgentsResponse> GetAsync(Action<AgentsRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
